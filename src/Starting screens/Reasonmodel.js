...
import Denidemodel from './Denidemodel';

const Reasonmodel = ({ navigation}) => {
    ...
    return (
            <Pressable style={styles.container}>
                ...
                <Pressable style={[styles.button, { backgroundColor: checked == false ? 'gray' : '#33CCCC', top: moderateScale(20) }]} onPress={toggleModal}>
                    <Text style={styles.text6}>APPLY</Text>
                    <Denidemodel isVisible={isModalVisible} onOff={toggleModal}/>
                </Pressable>
            </Pressable>
    );
}
