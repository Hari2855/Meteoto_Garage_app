...
const Requestmodel = ({ isVisible, onCancel, onConfirm, navigation }) => {
            ...
            <Pressable style={styles.modalContent}>
                ...
                <View style={styles.container}>
                    <View style={styles.car}>
                        <Image source={require('../Assets/Verna.png')} style={styles.img}/>
                    </View>
                ...
                <View style={styles.container2}>
                        ...
                        <View style={styles.container4}>
                            <View style={styles.container5}>
                              <View style={styles.img2}>
                                    <Image source={require("../Assets/Alternator.png")} style={{width: scale(28), height: scale(28)}} />
                              </View>
                            </View>
                    ...
                    <View style={styles.container6}>
                        <Pressable style={styles.button} onPress={() => navigation.navigate('Reason')}>
                            <Text style={[styles.text1, {fontSize: moderateScale(12), color: '#ffffff'}]}>DENY</Text>
                        </Pressable>
                        <Pressable style={[styles.button, { backgroundColor: '#6DA007'}]} onPress={() => navigation.navigate('Response')}>
