...
const Otpmodel = ({ isVisible, onCancel, onConfirm, navigation }) => {
    ...
    return (
        <Modal isVisible={isVisible} backdropOpacity={0.5} animationIn={'fadeIn'} animationOut={'fadeOut'}>
            <View style={styles.modalContent}>
                ...
                <Pressable style={[styles.button, { backgroundColor: areDetailsFilled() == false ? '#999999' : '#33CCCC' }]} onPress={() => navigation.navigate('Successotp1')}>
