...
const Feedback = ({navigation}) => {
  return (
    <View style={styles.container}>
          <Header title={'FEEDBACK'} onPress={() => navigation.goBack()} marginLeft={'27%'} />


          <View style={styles.container1}>
              <Image source={require('../Assets/plant.gif')} style={styles.img2} />
          ...
          <View style={{top: '8%'}}>
              <Button title={'SUBMIT'} bgColor={'#33CCCC'}/>
          </View>
    </View>
  )
}
