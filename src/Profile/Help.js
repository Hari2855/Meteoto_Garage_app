...
const Help = ({navigation}) => {
  return (
    <View style={styles.container}>
          <Header title={'HELP & SUPPORT'} onPress={() => navigation.goBack()} marginLeft={'23%'} />

          <Pressable style={styles.container2} onPress={() => navigation.navigate('Contact')}>
              <Image source={require('../Assets/contact.png')} style={styles.img3} />
          ...
          <Pressable style={styles.container2} onPress={() => navigation.navigate('Feedback')}>
              <Image source={require('../Assets/Gif.gif')} style={styles.img3} />
              ...
              <Image source={require('../Assets/Vector1.png')} style={[styles.img4, {marginLeft: '35%'}]} />
          </Pressable>
    </View>
  )
}
