...
const Alternatenumber = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <Header title={'MY PROFILE'} onPress={() => navigation.goBack()} marginLeft={'28%'} />
      ...
      <View style={styles.input1}>
        ...
        <Image source={require('../Assets/edit.png')} style={styles.img2} />
      </View>

      {/* <Pressable style={styles.button} onPress={toggleModal}>
        <Text style={[styles.text1]}>VERIFY NUMBER</Text>
        <Otpmodel isVisible={isModalVisible} onCancel={toggleModal} navigation={navigation}/>
      </Pressable> */}

      <View style={{ top: '60%' }}>
        <Button title={'VERIFY NUMBER'} bgColor={'#33CCCC'} onPress={() => toggleModal()} />
        <Otpmodel isVisible={isModalVisible} onCancel={toggleModal} navigation={navigation} />
      </View>
    </View>
  )
