...
import Detailsmodel from '../Completed/Detailsmodel'
import Header from '../Component/Header'

const Jobcard4 = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <Pressable style={styles.container4} onPress={() => navigation.navigate('Payments')}>
                <Text style={[styles.text1, { color: '#333333', fontFamily: 'Nunito Sans', marginLeft: moderateScale(20) }]}>P A Y M E N T  D E T A I L S</Text>

                <Pressable style={styles.container5} onPress={() => navigation.navigate('Payments')}>
