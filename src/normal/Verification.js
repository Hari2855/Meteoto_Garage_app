...
const Verification = ({ navigation, route }) => {
    const receivedOTP = String(route.params?.otp);
    // const {phonenumber} = route.params
    console.log(receivedOTP, '00000');
    ...
    const handleVerify = async () => {
        const enteredOTP = box1 + box2 + box3 + box4;
    ...
    return (
        <View style={styles.container1}>
            <ImageBackground source={require('../Assets/Frame.png')} style={styles.imgbgc}>
                ...
                <Image source={require('../Assets/back.png')} style={styles.img1}/>
                </Pressable>
            </ImageBackground>
            ...
            <View style={{ marginTop: '20%' }}>
                <Button title={'VERIFY'} bgColor={'red'} onPress={Nav} />
            </View>
        </View>
    )
}
